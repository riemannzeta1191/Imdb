...
from .import views
from .views import SearchMovies,ElasticSearch,GenreSearch,BestMovies,SearchByGenreAndDirector,MovieCRUD
app_name = "movies"
...
urlpatterns = [
    ...
    url(r'^movie/(?P<id>[0-9]+)/$', MovieCRUD.as_view(), name='movie_crud')
 ]
